...
export const updatePatient = async (patient) => {
  try {
    const response = await axios.put(
      api_url + patientsRoute + `/${patient.id}`,
      patient
    );
    return response;
  } catch (err) {
...
export const getAllAppointments = async () => {
  try {
    const response = await axios.get(api_url + appointmentsRoute);
    return response;
  } catch (err) {
    return err;
  }
...
export const updateAppointment = async (appointment) => {
  try {
    const response = await axios.put(
      api_url + appointmentsRoute + `/${appointment.id}`,
      appointment
    );
    return response;
  } catch (err) {
...
export const searchAppointmentByDate = async (date) => {
  try {
    const response = await axios.get(
      api_url + appointmentsRoute + `/date/${date}`
    );
    return response;
  } catch (err) {
    return err;
...
export const updateInvoice = async (invoice) => {
  try {
    const response = await axios.put(
      api_url + invoicesRoute + `/${invoice.id}`,
      invoice
    );
    return response;
  } catch (err) {
...
export const updateTreatment = async (treatment) => {
  try {
    const response = await axios.put(
      api_url + treatmentsRoute + `/${treatment.id}`,
      treatment
    );
    return response;
  } catch (err) {
